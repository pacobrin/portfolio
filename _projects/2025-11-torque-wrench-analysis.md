...
image: /assets/images/normal_stress.jpeg
---
...
The full written analysis and report can be found [here]({{ "/assets/LastHW.pdf" | relative_url }}).

The design rendering is very simple geometry, as shown below.

![rendered cad]({{ "/assets/images/rendered_cad.jpeg" | relative_url }}){: width: 300px}
![exploded cad]({{ "/assets/images/exploded_cad.jpg" | relative_url }}){: width: 300px}

Diagram communicating how loads and boundary conditions were applied to the FEM model:

![boundary FEM]({{ "/assets/images/boundary_cad.jpg" | relative_url }}){: width: 300px}

Normal strain contours (in the strain gauge direction):

![normal strain]({{ "/assets/images/normal_strain.jpg" | relative_url }}){: width: 300px}

Contour plot of maximum principal stress from FEM:

![normal stress]({{ "/assets/images/normal_stress.jpg" | relative_url }}){: width: 300px}
